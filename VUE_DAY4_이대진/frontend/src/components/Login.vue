              ...
              <div class="modal-container p-4">
                  <div class="h4 modal-header d-flex flex-column align-items-center">
                      ...
                      <div class="mt-3 ml-auto">
                          <b-form-checkbox id="checkbox-1" v-model="seller" name="checkbox-1">판매자로 로그인</b-form-checkbox>
                      </div>
...
export default {
    ...
    methods: {
        ...
        moveSignup(){
            this.SET_RESGISTER_MODAL(true);
        },
        ...mapMutations(["SET_LOGIN_MODAL", "SET_RESGISTER_MODAL", "SET_LOGIN_DATA"])
    }
}
</script>
